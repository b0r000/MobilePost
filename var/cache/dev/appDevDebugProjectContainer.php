...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            'addessdata_form.handler' => 'getAddessdataForm_HandlerService',
            ...
            'parcel_form.handler' => 'getParcelForm_HandlerService',
            'parcelorder_form.handler' => 'getParcelorderForm_HandlerService',
    ...
    /**
     * Gets the 'addessdata_form.handler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Handler\AddressDataFormHandler A AppBundle\Handler\AddressDataFormHandler instance.
     */
    protected function getAddessdataForm_HandlerService()
    {
        return $this->services['addessdata_form.handler'] = new \AppBundle\Handler\AddressDataFormHandler($this->get('doctrine.orm.default_entity_manager'), 'AppBundle\\Entity\\AddressData', $this->get('form.factory'), 'AppBundle\\Form\\AddressDataType');
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => '31c_db', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_e012f9c13ca4efac09ca6a8fe6c555e14dca7ece065029b54b46a994c141112d');
    ...
    /**
     * Gets the 'parcel_form.handler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Handler\ParcelFormHandler A AppBundle\Handler\ParcelFormHandler instance.
     */
    protected function getParcelForm_HandlerService()
    {
        return $this->services['parcel_form.handler'] = new \AppBundle\Handler\ParcelFormHandler($this->get('doctrine.orm.default_entity_manager'), 'AppBundle\\Entity\\Parcel', $this->get('form.factory'), 'AppBundle\\Form\\ParcelType');
    }

    /**
     * Gets the 'parcelorder_form.handler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Handler\ParcelOrderFormHandler A AppBundle\Handler\ParcelOrderFormHandler instance.
     */
    protected function getParcelorderForm_HandlerService()
    {
        return $this->services['parcelorder_form.handler'] = new \AppBundle\Handler\ParcelOrderFormHandler($this->get('doctrine.orm.default_entity_manager'), 'AppBundle\\Entity\\ParcelOrder', $this->get('form.factory'), 'AppBundle\\Form\\ParcelOrderType');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('b1b4161d173649c61d09eea207e9a48f6b5c19a6');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('573ef537c8e482.13478634')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => 'b1b4161d173649c61d09eea207e9a48f6b5c19a6',
            ...
            'kernel.secret' => 'b1b4161d173649c61d09eea207e9a48f6b5c19a6',
